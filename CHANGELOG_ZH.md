...
- PeakEWMA 支持配置客户端错误和服务器错误的不同偏差值 (#2337) @ncghost1
- 支持为 UDP 监听器和连接设置 reuseport 选项 (#2348) @dengqian
- Trace 集成 OTel (#2359) (#2370) @971800718
- XProtocol 增加快速失败健康检测功能 (#2364) (#2373) @hui-cha

### 变更

- 更新依赖 (#2350) (#2351) (#2352) (#2353) @dependabot

### 优化

- 减小 UDP 读取缓冲区大小 (#2349) @dengqian

### Bug 修复

- 为每个查询创建新的 DNS 消息，以避免受上一个查询结果的影响 (#2344) @dengqian
- 修复 unary recover 时未返回错误 (#2363) @wenxuwan
- 修复 lbconfig 没有正确使用默认值的错误 (#2375) @NX-Official
